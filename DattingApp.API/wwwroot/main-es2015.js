...
let MemberEditResolver = class MemberEditResolver {
    constructor(userService, router, alertify, auth) {
        this.userService = userService;
        this.router = router;
        this.alertify = alertify;
        this.auth = auth;
    ...
    resolve(route) {
        // tslint:disable-next-line: no-string-literal
        return this.userService.getUser(this.auth.decodedToken.nameid).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(error => {
...
let MessagesResolver = class MessagesResolver {
    constructor(auth, userService, router, alertify) {
        this.auth = auth;
        this.userService = userService;
        this.router = router;
        this.alertify = alertify;
    ...
    resolve(route) {
        // tslint:disable-next-line: no-string-literal
        return this.userService.getMessages(this.auth.decodedToken.nameid, this.pageNumber, this.pageSize, this.messageContainer).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(error => {
...
let UserService = class UserService {
    ...
    getUsers(page, itemsPerPage, userParams, likesParam) {
        const paginationResult = new _models_pagination__WEBPACK_IMPORTED_MODULE_1__["PaginatedResult"]();
...
/* harmony import */ var time_ago_pipe__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! time-ago-pipe */ "./node_modules/time-ago-pipe/esm2015/time-ago-pipe.js");
...
let ListsComponent = class ListsComponent {
    constructor(auth, userService, route, alertify) {
        this.auth = auth;
        this.userService = userService;
        this.route = route;
        this.alertify = alertify;
...
let MemberCardComponent = class MemberCardComponent {
    constructor(auth, userService, alertify) {
        this.auth = auth;
        this.userService = userService;
        this.alertify = alertify;
    }
...
let MemberEditComponent = class MemberEditComponent {
    constructor(route, alertify, userService, auth) {
        this.route = route;
        this.alertify = alertify;
        this.userService = userService;
        this.auth = auth;
...
let MemberMessagesComponent = class MemberMessagesComponent {
    constructor(userService, auth, alertify) {
        this.userService = userService;
        this.auth = auth;
        this.alertify = alertify;
        this.newMessage = {};
    ...
    loadMessages() {
        ...
        this.userService.getMessageThread(this.auth.decodedToken.nameid, this.recipientID)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(m => {
            // tslint:disable-next-line: prefer-for-of
    ...
    sendMessage() {
        ...
        this.userService.sendMessage(this.auth.decodedToken.nameid, this.newMessage).subscribe((m) => {
...
let MessagesComponent = class MessagesComponent {
    constructor(userService, auth, route, alertify) {
        this.userService = userService;
        this.auth = auth;
        this.route = route;
        this.alertify = alertify;
...
let NavComponent = class NavComponent {
    constructor(auth, alertify, router) {
        this.auth = auth;
        this.alertify = alertify;
        this.router = router;
        this.model = {};
...
let RegisterComponent = class RegisterComponent {
    constructor(auth, alertify, fb, router) {
        this.auth = auth;
        this.alertify = alertify;
        this.fb = fb;
        this.router = router;
