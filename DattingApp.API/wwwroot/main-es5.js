...
var MemberEditResolver = /** @class */ (function () {
    function MemberEditResolver(userService, router, alertify, auth) {
        this.userService = userService;
        this.router = router;
        this.alertify = alertify;
        this.auth = auth;
    ...
    MemberEditResolver.prototype.resolve = function (route) {
        var _this = this;
        // tslint:disable-next-line: no-string-literal
        return this.userService.getUser(this.auth.decodedToken.nameid).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (error) {
...
var MessagesResolver = /** @class */ (function () {
    function MessagesResolver(auth, userService, router, alertify) {
        this.auth = auth;
        this.userService = userService;
        this.router = router;
        this.alertify = alertify;
    ...
    MessagesResolver.prototype.resolve = function (route) {
        var _this = this;
        // tslint:disable-next-line: no-string-literal
        return this.userService.getMessages(this.auth.decodedToken.nameid, this.pageNumber, this.pageSize, this.messageContainer).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (error) {
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _models_pagination__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./../_models/pagination */ "./src/app/_models/pagination.ts");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.getUsers = function (page, itemsPerPage, userParams, likesParam) {
        var paginationResult = new _models_pagination__WEBPACK_IMPORTED_MODULE_1__["PaginatedResult"]();
    ...
    UserService.prototype.getMessages = function (id, page, itemsPerPage, messageContainer) {
        var paginatedResult = new _models_pagination__WEBPACK_IMPORTED_MODULE_1__["PaginatedResult"]();
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpParams"]();
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _members_member_messages_member_messages_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./members/member-messages/member-messages.component */ "./src/app/members/member-messages/member-messages.component.ts");
/* harmony import */ var _resolvers_messages_resolver__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./_resolvers/messages.resolver */ "./src/app/_resolvers/messages.resolver.ts");
...
/* harmony import */ var _members_photo_editor_photo_editor_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./members/photo-editor/photo-editor.component */ "./src/app/members/photo-editor/photo-editor.component.ts");
/* harmony import */ var _guards_prevent_unsaved_changes_guard__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./_guards/prevent-unsaved-changes.guard */ "./src/app/_guards/prevent-unsaved-changes.guard.ts");
/* harmony import */ var _resolvers_member_edit_resolver__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./_resolvers/member-edit.resolver */ "./src/app/_resolvers/member-edit.resolver.ts");
...
/* harmony import */ var _services_error_interceptor__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./_services/error.interceptor */ "./src/app/_services/error.interceptor.ts");
/* harmony import */ var _services_alertify_service__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./_services/alertify.service */ "./src/app/_services/alertify.service.ts");
/* harmony import */ var _members_member_list_member_list_component__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./members/member-list/member-list.component */ "./src/app/members/member-list/member-list.component.ts");
...
/* harmony import */ var _services_user_service__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! ./_services/user.service */ "./src/app/_services/user.service.ts");
...
/* harmony import */ var _resolvers_member_detail_resolver__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(/*! ./_resolvers/member-detail.resolver */ "./src/app/_resolvers/member-detail.resolver.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_11__["NgModule"])({
            declarations: [
                ...
                _members_member_list_member_list_component__WEBPACK_IMPORTED_MODULE_26__["MemberListComponent"],
                ...
                _members_member_edit_member_edit_component__WEBPACK_IMPORTED_MODULE_7__["MemberEditComponent"],
                _members_photo_editor_photo_editor_component__WEBPACK_IMPORTED_MODULE_4__["PhotoEditorComponent"],
                time_ago_pipe__WEBPACK_IMPORTED_MODULE_18__["TimeAgoPipe"],
                _members_member_messages_member_messages_component__WEBPACK_IMPORTED_MODULE_1__["MemberMessagesComponent"]
            ],
            imports: [
                ...
                ngx_bootstrap__WEBPACK_IMPORTED_MODULE_14__["BsDropdownModule"].forRoot(),
                ...
                _angular_router__WEBPACK_IMPORTED_MODULE_15__["RouterModule"].forRoot(_routes__WEBPACK_IMPORTED_MODULE_29__["appRoutes"]),
            ...
            providers: [
                ...
                _services_error_interceptor__WEBPACK_IMPORTED_MODULE_24__["ErrorInterceptorProvide"],
                _services_alertify_service__WEBPACK_IMPORTED_MODULE_25__["AlertifyService"],
                _guards_auth_guard__WEBPACK_IMPORTED_MODULE_30__["AuthGuard"],
                _services_user_service__WEBPACK_IMPORTED_MODULE_31__["UserService"],
                _resolvers_member_detail_resolver__WEBPACK_IMPORTED_MODULE_33__["MemberDetailResolver"],
                _resolvers_member_list_resolver__WEBPACK_IMPORTED_MODULE_8__["MemberListResolver"],
                _resolvers_member_edit_resolver__WEBPACK_IMPORTED_MODULE_6__["MemberEditResolver"],
                _guards_prevent_unsaved_changes_guard__WEBPACK_IMPORTED_MODULE_5__["PreventUnsavedChanges"],
                _resolvers_lists_resolver__WEBPACK_IMPORTED_MODULE_3__["ListsResolver"],
                _resolvers_messages_resolver__WEBPACK_IMPORTED_MODULE_2__["MessagesResolver"]
            ],
            bootstrap: [
                _app_component__WEBPACK_IMPORTED_MODULE_19__["AppComponent"]
            ]
...
var ListsComponent = /** @class */ (function () {
    function ListsComponent(auth, userService, route, alertify) {
        this.auth = auth;
        this.userService = userService;
        this.route = route;
        this.alertify = alertify;
...
module.exports = ".card:hover img {\r\n    -webkit-transform: scale(1.2, 1.2);\r\n            transform: scale(1.2, 1.2);\r\n    -webkit-transition-duration: 500ms;\r\n            transition-duration: 500ms;\r\n    -webkit-transition-timing-function: ease-out;\r\n            transition-timing-function: ease-out;\r\n    opacity: 0.7;\r\n}\r\n.card img {\r\n    -webkit-transform: scale(1.0, 1.0);\r\n            transform: scale(1.0, 1.0);\r\n    -webkit-transition-duration: 500ms;\r\n            transition-duration: 500ms;\r\n    -webkit-transition-timing-function: ease-out;\r\n            transition-timing-function: ease-out;\r\n}\r\n.card-img-wrapper {\r\n    overflow: hidden;\r\n    position: relative;\r\n}\r\n.member-icons {\r\n    position: absolute;\r\n    bottom: -30%;\r\n    left: 0;\r\n    right: 0;\r\n    margin-right: auto;\r\n    margin-left: auto;\r\n    opacity: 0;\r\n}\r\n.card-img-wrapper:hover .member-icons {\r\n    bottom: 0;\r\n    opacity: 1;\r\n}\r\n.animate {\r\n    -webkit-transition: all 0.3s ease-in-out;\r\n    transition: all 0.3s ease-in-out;\r\n}\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
var MemberCardComponent = /** @class */ (function () {
    function MemberCardComponent(auth, userService, alertify) {
        this.auth = auth;
        this.userService = userService;
        this.alertify = alertify;
    }
    ...
    MemberCardComponent.prototype.sendLike = function (id) {
        var _this = this;
        this.userService.sendLike(this.auth.decodedToken.nameid, id).subscribe(function (data) {
            _this.alertify.success('You have liked: ' + _this.user.knownAs);
        }, function (error) {
            _this.alertify.error('You already like this user');
        });
    };
...
module.exports = ".img-thumbnail {\r\n    margin: 25px;\r\n    width: 85%;\r\n    height: 85%;\r\n}\r\n\r\n.card-body {\r\n    padding: 0 25px;\r\n}\r\n\r\n.card-footer {\r\n    padding: 10px 15px;\r\n    background-color: white;\r\n    border-top: none;\r\n}\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
var MemberDetailComponent = /** @class */ (function () {
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["ViewChild"])('memberTabs', { static: false })
...
module.exports = ".img-thumbnail {\r\n    margin: 25px;\r\n    width: 85%;\r\n    height: 85%;\r\n}\r\n\r\n.card-body {\r\n    padding: 0 25px;\r\n}\r\n\r\n.card-footer {\r\n    padding: 10px 15px;\r\n    background-color: white;\r\n    border-top: none;\r\n}\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
var MemberEditComponent = /** @class */ (function () {
    function MemberEditComponent(route, alertify, userService, auth) {
        this.route = route;
        this.alertify = alertify;
        this.userService = userService;
        this.auth = auth;
    ...
    MemberEditComponent.prototype.ngOnInit = function () {
        ...
        this.auth.currentPhotoUrl.subscribe(function (photoUrl) { return _this.photoUrl = photoUrl; });
    };
    MemberEditComponent.prototype.updateUser = function () {
        var _this = this;
        this.userService.updateUser(this.auth.decodedToken.nameid, this.user).subscribe(function (next) {
            _this.alertify.success('Profile Changed!');
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_5__["ViewChild"])('editForm', { static: false })
...
module.exports = ".card {\r\n    border: none;\r\n}\r\n\r\n.chat {\r\n    list-style: none;\r\n    margin: 0;\r\n    padding: 0;\r\n}\r\n\r\n.chat li {\r\n    margin-bottom: 10px;\r\n    padding-bottom: 10px;\r\n    border-bottom: 1px dotted #b3a9a9;\r\n}\r\n\r\n.rounded-circle {\r\n    height: 50px;\r\n    width: 50px;\r\n}\r\n\r\n.card-body {\r\n    overflow: scroll;\r\n    height: 400px;\r\n}\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
var MemberMessagesComponent = /** @class */ (function () {
    function MemberMessagesComponent(userService, auth, alertify) {
        this.userService = userService;
        this.auth = auth;
        this.alertify = alertify;
        this.newMessage = {};
    ...
    MemberMessagesComponent.prototype.loadMessages = function () {
        var _this = this;
        var currentUserID = +this.auth.decodedToken.nameid;
        this.userService.getMessageThread(this.auth.decodedToken.nameid, this.recipientID)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(function (m) {
            // tslint:disable-next-line: prefer-for-of
            for (var i = 0; i < m.length; i++) {
                if (m[i].isRead === false && m[i].recipientID === currentUserID) {
                    _this.userService.markAsRead(currentUserID, m[i].id);
                }
            }
        }))
    ...
    MemberMessagesComponent.prototype.sendMessage = function () {
        ...
        this.userService.sendMessage(this.auth.decodedToken.nameid, this.newMessage).subscribe(function (m) {
...
module.exports = "img.img-thumbnail {\r\n    height: 100px;\r\n    width: 100px !important;\r\n    margin-bottom: 2px;\r\n}\r\n.nv-file-over {\r\n    border: dotted 3px red;\r\n}\r\ninput[type=file] {\r\n    color: transparent;\r\n}\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
var PhotoEditorComponent = /** @class */ (function () {
    function PhotoEditorComponent(auth, userService, alertify) {
        this.auth = auth;
        this.userService = userService;
        this.alertify = alertify;
        this.getMemberPhotoChange = new _angular_core__WEBPACK_IMPORTED_MODULE_5__["EventEmitter"]();
    ...
    PhotoEditorComponent.prototype.ngOnInit = function () {
        ...
        this.currentMain = this.photos.filter(function (p) { return p.isMain === true; })[0];
    };
    ...
    PhotoEditorComponent.prototype.initializeUploader = function () {
        ...
        this.uploader.onSuccessItem = function (item, response, status, headers) {
            if (response) {
                ...
                if (photo.isMain) {
                    _this.auth.changeMemberPhoto(photo.url);
                    _this.auth.currentUser.photoUrl = photo.url;
                    localStorage.setItem('user', JSON.stringify(_this.auth.currentUser));
                }
            }
        };
    };
    PhotoEditorComponent.prototype.setMainPhoto = function (photo) {
        var _this = this;
        this.userService.setMainPhoto(this.auth.decodedToken.nameid, photo.id).subscribe(function () {
    ...
    PhotoEditorComponent.prototype.deletePhoto = function (id) {
        ...
        this.alertify.confirm('Are you sure you want to delete this photo?', function () {
            _this.userService.deletePhoto(_this.auth.decodedToken.nameid, id).subscribe(function () {
...
module.exports = "table {\r\n    margin-top: 15px;\r\n}\r\n.img-circle {\r\n    max-height: 50px;\r\n}\r\ntd {\r\n    vertical-align: middle;\r\n}\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
var MessagesComponent = /** @class */ (function () {
    function MessagesComponent(userService, auth, route, alertify) {
        this.userService = userService;
        this.auth = auth;
        this.route = route;
        this.alertify = alertify;
    ...
    MessagesComponent.prototype.loadMessages = function () {
        var _this = this;
        this.userService.getMessages(this.auth.decodedToken.nameid, this.pagination.currentPage, this.pagination.itemsPerPage, this.messageContainer)
            .subscribe(function (res) {
    ...
    MessagesComponent.prototype.deleteMessage = function (id) {
        ...
        this.alertify.confirm('Are you sure you want delete this message', function () {
            _this.userService.deleteMessage(id, _this.auth.decodedToken.nameid).subscribe(function () {
...
module.exports = ".dropdown-toggle .dropdown-item{\r\n    cursor: pointer;\r\n}\r\n\r\nimg {\r\n    max-width: 50px;\r\n    border: 2px solid white;\r\n    display: inline;\r\n}\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
var NavComponent = /** @class */ (function () {
    function NavComponent(auth, alertify, router) {
        this.auth = auth;
        this.alertify = alertify;
        this.router = router;
        this.model = {};
...
var RegisterComponent = /** @class */ (function () {
    function RegisterComponent(auth, alertify, fb, router) {
        this.auth = auth;
        this.alertify = alertify;
        this.fb = fb;
        this.router = router;
    ...
    RegisterComponent.prototype.register = function () {
        ...
        if (this.registerForm.valid) {
            ...
            this.auth.register(this.user).subscribe(function () {
                ...
                _this.auth.login(_this.user).subscribe(function () {
                    _this.router.navigate(['/members']);
                });
            });
        }
...
/* harmony import */ var _guards_prevent_unsaved_changes_guard__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./_guards/prevent-unsaved-changes.guard */ "./src/app/_guards/prevent-unsaved-changes.guard.ts");
...
/* harmony import */ var _resolvers_member_list_resolver__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./_resolvers/member-list.resolver */ "./src/app/_resolvers/member-list.resolver.ts");
...
var appRoutes = [
    { path: '', component: _home_home_component__WEBPACK_IMPORTED_MODULE_11__["HomeComponent"] },
    {
        ...
        children: [
            { path: 'members', component: _members_member_list_member_list_component__WEBPACK_IMPORTED_MODULE_10__["MemberListComponent"], resolve: { users: _resolvers_member_list_resolver__WEBPACK_IMPORTED_MODULE_4__["MemberListResolver"] } },
            { path: 'members/:id', component: _members_member_detail_member_detail_component__WEBPACK_IMPORTED_MODULE_6__["MemberDetailComponent"], resolve: { user: _resolvers_member_detail_resolver__WEBPACK_IMPORTED_MODULE_5__["MemberDetailResolver"] } },
            { path: 'member/edit', component: _members_member_edit_member_edit_component__WEBPACK_IMPORTED_MODULE_3__["MemberEditComponent"],
                resolve: { user: _resolvers_member_edit_resolver__WEBPACK_IMPORTED_MODULE_12__["MemberEditResolver"] }, canDeactivate: [_guards_prevent_unsaved_changes_guard__WEBPACK_IMPORTED_MODULE_2__["PreventUnsavedChanges"]] },
            ...
            { path: 'lists', component: _lists_lists_component__WEBPACK_IMPORTED_MODULE_8__["ListsComponent"], resolve: { users: _resolvers_lists_resolver__WEBPACK_IMPORTED_MODULE_1__["ListsResolver"] } },
        ]
    },
...
module.exports = __webpack_require__(/*! D:\dcode\DatingApp\DatingApp-SPA\src\main.ts */"./src/main.ts");
